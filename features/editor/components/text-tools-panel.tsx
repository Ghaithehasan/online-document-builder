...
export function TextToolsPanel({ editor, bare = false }: TextToolsPanelProps) {
  ...
  // Match badge used in both modes
  const matchBadge = (
    <div
      className={[
  ...
  // bare mode: no card wrapper, no separate header (used inside the tool panel)
  if (bare) {
